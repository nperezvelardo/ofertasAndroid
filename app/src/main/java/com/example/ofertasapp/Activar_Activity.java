...
import Utilidades.ListViewAdapterActivar;

public class Activar_Activity extends AppCompatActivity {

    List<Usuario> listaUser = new ArrayList<>();  //para guardar el listado de usuarios
    private static final String JSON_URL = "http://ofertasapp.es/userActivar";  //url donde realizamos la petición para obtener los usuarios
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ListViewAdapterActivar adapter = new ListViewAdapterActivar(listaUser, getApplicationContext());
                            ...
                            if(listaUser.isEmpty())
                                Toast.makeText(getApplicationContext(), "No hay usuarios para activar", Toast.LENGTH_LONG).show();
